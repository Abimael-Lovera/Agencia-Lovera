...
namespace Lovera.Controllers
{
    public class DestinosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdDestino,Nome,Descripcao")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDestino,Nome,Descripcao")] Destino destino)
        {
